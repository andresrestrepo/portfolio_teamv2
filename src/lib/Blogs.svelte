...
<div in:fly={{ y: 300, x: 300 }}>
  <HeaderPage
    letter="b"
    next="logs"
    description="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore, officia ipsum eum. Illo pariatur sapiente laborum quis accusamus eius doloribus necessitatibus!"
  ></HeaderPage>
